...
class ArticleManager(models.Manager):
    def distinct_date(self):
        ...
        for date in date_list:
            date = date['date_publish'].strftime('%Y{0}%m{1}').format('年', '月文章归档')
...
class Article(models.Model):
    ...
    category = models.ForeignKey(Category, blank=True, null=True, on_delete=models.CASCADE, verbose_name='分类')
